...
- rewrite_request_name_total{server, match_type, src_domain_name, dest_domain_name}
- rewrite_request_name_noop_total{server, match_type, src_domain_name}
...
- rewrite_response_name_total{server, src_domain_name, dest_domain_name}
